...
exports.init = exports.createUi = void 0;
const createUi = ({ constants, storage, logger, parser, urlTool, timeouts, }) => {
    ...
    const createDialog = () => {
        ...
        for (const [videoId, { humanTime, value, videoName: streamName, channelName: streamerName, url, },] of storedValues) {
...
const init = ({ logger, registerMenu, ui, storage, }) => {
